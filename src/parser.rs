...
//     fn conditional_statement(&mut self) -> Node {

//         let mut t = Node::new()
//             .type_(NodeType::Cond)
//             .add_child(
//                 Node::new()
//                 .val(self.lexer.eat(KEYWORD_TABLE["if"].clone()))
//                 .type_(NodeType::Cond)
//             )
//             .add_child(self.bool_expr())
//             .add_child(self.statement());
...
//             t = t.add_child(
//                 Node::new()
//                     .val(self.lexer.eat(KEYWORD_TABLE["else"].clone()))
//                     .type_(NodeType::Cond),
//             );

//             t = t.add_child(self.statement());
//         }
